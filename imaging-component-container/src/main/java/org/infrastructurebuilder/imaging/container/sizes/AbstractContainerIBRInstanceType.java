...
abstract public class AbstractContainerIBRInstanceType extends AbstractStringBackedIBRInstanceType {

  public AbstractContainerIBRInstanceType(String id, int order) {
    super(TYPE, id, "default", order);
  }
