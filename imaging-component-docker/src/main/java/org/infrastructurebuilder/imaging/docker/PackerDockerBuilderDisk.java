...
import static org.infrastructurebuilder.imaging.docker.DockerV1Constants.CONTAINER_PATH;
import static org.infrastructurebuilder.imaging.docker.DockerV1Constants.DOCKER;
import static org.infrastructurebuilder.imaging.docker.DockerV1Constants.HOST_PATH;
...
public class PackerDockerBuilderDisk extends AbstractPackerBuilderDisk {
  ...
  public List<String> getNamedTypes() {
    return PackerDockerBuilder.namedTypes;
  }
