...
import org.infrastructurebuilder.imaging.docker.PackerDockerBuilder;
import org.infrastructurebuilder.imaging.docker.PackerDockerBuilderDisk;
...
public class PackerDockerBuilderTest {
  ...
  private PackerDockerBuilder p;

  @Before
  public void setUp() throws Exception {
    p = new PackerDockerBuilder();
  ...
  public void testGetAuthType() {
    assertEquals(DOCKER, p.getAuthType().get());
  }
  ...
  public void testGetLookupHint() {
    assertEquals(DOCKER, p.getLookupHint().get());
  }

  @Test
  public void testGetNamedTypes() {
    assertEquals(1, p.getNamedTypes().size());
    assertEquals(DOCKER, p.getNamedTypes().iterator().next());
  }

  @Test
  public void testGetPackerType() {
    assertEquals(DOCKER, p.getPackerType());
  }
